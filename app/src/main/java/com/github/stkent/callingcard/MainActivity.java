...
public class MainActivity extends AppCompatActivity
    ...
    private static final DeviceData PUBLISH_DATA = new DeviceData();

    private static final Message PUBLISH_MESSAGE
            = new Message(new Gson().toJson(PUBLISH_DATA).getBytes());
    ...
    protected void onCreate(@Nullable final Bundle savedInstanceState) {
        ...
        publishedMessageField.setText(PUBLISH_DATA.toString());
    ...
    private void attemptToPublish() {
        ...
        Nearby.Messages.publish(googleApiClient, PUBLISH_MESSAGE, publishOptions)
    ...
    private void stopPublishing() {
        ...
        Nearby.Messages.unpublish(googleApiClient, PUBLISH_MESSAGE);
    }
